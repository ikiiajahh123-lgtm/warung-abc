...
$sql_detail = "SELECT d.jumlah, d.subtotal, d.nama_barang, d.harga_satuan";
$sql_detail .=" FROM tbl_transaksi d";
...
<body>
    ...
    <p>
        ...
        'Umum'; ?>
            ...
            <tr><th>Barang</th>Harga<th></th><th>jumlah</yh><th>Subtotal</th></tr>
